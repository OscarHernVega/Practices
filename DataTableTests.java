...
public class DataTableTests extends BaseTest {
    ...
    private final By DUE_ELEMENT_LOCATOR = By.xpath(xpathExpression: //*[@id="table1"]/tbody/tr[4]/td[4])
    ...
    public void dataTableTest() {
        ...
        for(webElement element:dueList){
            ...
            actualSum += Double.parseDouble(elementTest.replaceAll(CURENCY_REGEX, replacement: ""));
        }
        Assert.assertEquals(actualSum, Expected_SUM, message: "Sum is not correct");
        // todo: assert due sum
    }
}
