...
public class DynamicControlsTest extends BaseTest {
    ...
    private final By INPUT =By.xpath (xpathExpression: "//*[@id="input-example"]//input");
    ...
    public void dynamicControlsTest() {
        ...
        Assert.assertTrue(isClickable(inputField), message: "element wasn't enabled");
        inputField.sendKeys(RANDOM_TEXT);
        Assert.assertTrue(driver.findElement(INPUT).getAttribute(name: "value"), RANDOM_TEXT, "Text is not displayed");
